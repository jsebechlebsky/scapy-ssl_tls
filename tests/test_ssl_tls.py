...
-----END RSA PRIVATE KEY-----
    ...
    def test_tls_certificate_x509(self):
        ...
        try:
            pkt_d[tls.TLSCertificate].data.tbsCertificate.subjectPublicKeyInfo.subjectPublicKey
        except AttributeError as ae:
            self.fail(ae)
        # compare pubkeys
        self.assertEqual(pkt[tls.TLSCertificate].data.tbsCertificate.subjectPublicKeyInfo.subjectPublicKey,
                         pkt_d[tls.TLSCertificate].data.tbsCertificate.subjectPublicKeyInfo.subjectPublicKey)
    ...
    def test_tls_certificate_x509_pubkey(self):
        ...
        keystore2 = tlsk.RSAKeystore.from_der_certificate(str(pkt[tls.TLSCertificate].data))
